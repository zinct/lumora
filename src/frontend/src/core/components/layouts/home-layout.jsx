...
export default function HomeLayout() {
  return (
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-border/40 backdrop-blur-2xl sticky top-0 bg-black/30 z-50">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                A decentralized, community-driven platform that incentivizes
                real-world eco-friendly actions through token rewards on the

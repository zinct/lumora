        ...
        >
          ...
          >
            <Button
              ...
              className="bg-beige-200 hover:bg-beige-300 text-beige-950 px-8 py-6 rounded-xl text-lg font-medium"
            >
              Contribute <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button
              variant="outline"
              className="border-beige-200 text-beige-200 hover:bg-beige-200/10 px-8 py-6 rounded-xl text-lg font-medium"
            >
              Learn More
            </Button>
          </motion.div>
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {projects.map((project, i) => (
                    <Card
                      key={project.id}
                      className="overflow-hidden bg-card border-border/40"
                    ...
                    >
                      <div className="relative aspect-square">
                        {project.image ? (
                          ...
                          <img
                            src={`https://api.dicebear.com/7.x/shapes/svg?seed=${project.title}&backgroundColor=c7d2fe,ddd6fe,fae8ff,dbeafe,bfdbfe,e0e7ff&shape1Color=4f46e5,6d28d9,7c3aed,2563eb,3b82f6,4f46e5`}
                            alt={project.title}
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center gap-3 mb-3">
                          <Avatar className="h-8 w-8 border-2 border-background -mt-8">
                            <AvatarImage
                              src={`https://api.dicebear.com/7.x/shapes/svg?seed=${project.title}&backgroundColor=c7d2fe&shape1Color=4f46e5`}
                              alt={project.title}
                            />
                            <AvatarFallback>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  >
                    <div className="relative aspect-square">
                      <img
                        src={`/placeholder.svg?height=300&width=300&text=Top ${
                          i + 1
                        }`}
                        alt={project.title}
                        fill

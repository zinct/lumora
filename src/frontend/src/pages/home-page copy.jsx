...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#eceae3]">
      ...
      {/* Footer */}
      <footer className="py-12 bg-[#eceae3] border-t border-[#eceae3]">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h2 className="text-2xl font-bold text-white">
                <span className="text-black">LUMORA</span>
              </h2>
              <p className="text-black text-sm">Decentralized Eco-Rewards Platform</p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-[#eceae3] text-center">
            <p className="text-black/70 text-sm">© {new Date().getFullYear()} Lumora. Built on Internet Computer Protocol.</p>
          </div>
        </div>
      </footer>
    </div>
